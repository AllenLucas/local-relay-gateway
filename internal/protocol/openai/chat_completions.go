...
func NormalizeChatCompletions(r *http.Request) (core.NormalizedRequest, error) {
	defer r.Body.Close()
...
func BuildChatCompletionsRequest(target core.ResolvedTarget, normalized core.NormalizedRequest) (*http.Request, error) {
	...
	url := strings.TrimRight(target.BaseURL, "/") + "/v1/chat/completions"
